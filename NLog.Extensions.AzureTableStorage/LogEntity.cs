    ...
    public class LogEntity : TableEntity
    {
        ...
        public LogEntity(LogEventInfo logEvent)
        {
            lock (_syncRoot)
            {
                ...
                LogTimeStamp = logEvent.TimeStamp.ToString("o");
                ...
                RowKey = (DateTime.MaxValue.Ticks - DateTime.UtcNow.Ticks).ToString("d19") + System.Threading.Thread.CurrentThread.ManagedThreadId;
        ...
        public static string GetExceptionDataAsString(Exception exception)
        {
